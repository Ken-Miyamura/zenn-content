...
この問題は、GORMの仕様を理解していないと遭遇しやすく、実際に私も開発中にハマってしまった経験があります。
...
私もこの問題でかなり時間を費やしてしまいました...😭

## 解決方法

![](https://raw.githubusercontent.com/Ken-Miyamura/zenn-content/main/images/4-solution.png)

この問題を解決するために、私は2つの方法を検討しました。最終的には**方法1のmap[string]interface{}を使う方法**で解決することができました。
...
2. **シンプルえ汎用的**: 最も直接的で理解しやすく、更新したい値のみ上書きして渡すようにしてるため、一般的なREST APIにおけるUpdateメソッドの役割に沿った作りにできている
...
これらの方法も状況によっては有効ですが、私のケースでは方法1のmap[string]interface{}が最適でした。
...
今回紹介した問題、false値のupdateって割と割と一般的なパターンのため、触って遭遇した人も多いかと思いますが、この仕様を知らないと中々びっくり且つ沼にハマることも多いのかなと思います。
